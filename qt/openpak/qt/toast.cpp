...
void NextendoToast::paintEvent(QPaintEvent*) {
    ...
    const QColor bg_color =
        openpak::qt::Host::Current()->IsDarkTheme() ? QColor(32, 32, 37, 250) : QColor(250, 250, 252, 250);
    ...
    painter.setPen(openpak::qt::Host::Current()->IsDarkTheme() ? QColor(240, 240, 243) : QColor(15, 15, 20));
    ...
    painter.setPen(openpak::qt::Host::Current()->IsDarkTheme() ? QColor(180, 180, 187) : QColor(90, 90, 100));
